  ...
  const iter = (currentValue1, currentValue2, depth) => {
    ...
    return uniqueSortedKeys.reduce((acc, key) => {
      if (_.isObject(currentValue1[key]) && _.isObject(currentValue2[key])) {
        return { ...acc, [key]: { case: 'nested', value: iter(currentValue1[key], currentValue2[key], depth + 2) } };
      }

      if (Object.hasOwn(currentValue1, key) && !Object.hasOwn(currentValue2, key)) {
        return { ...acc, [key]: { case: 'deleted', value: currentValue1[key] } };
      }

      if (!Object.hasOwn(currentValue1, key) && Object.hasOwn(currentValue2, key)) {
        return { ...acc, [key]: { case: 'added', value: currentValue2[key] } };
      }

      if (currentValue1[key] !== currentValue2[key]) {
        return { ...acc, [key]: { case: 'updated', previousValue: currentValue1[key], newValue: currentValue2[key] } };
      }

      return { ...acc, [key]: { case: 'equal', value: currentValue1[key] } };
    }, {});
  };
